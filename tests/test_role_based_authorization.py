...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({'admin': {'role': 'GUEST'}}, True, False, True),
        # Read role
        ({'admin': {'role': 'readOnly'}}, False, True, True),
        ({'admin': {'role': 'ReadOnly'}}, False, True, True),
        ({'admin': {'role': 'READONLY'}}, False, True, True),
        # Admin role
    ...
    ids=[
        ...
        'readonly_role_lowercase',
        'readonly_role_titlecase',
        'readonly_role_uppercase',
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({'admin': {'role': 'readOnly'}}, len(READ_ONLY_TOOLS), False),
        ({'admin': {'role': 'READONLY'}}, len(READ_ONLY_TOOLS), False),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({'admin': {'role': 'readOnly'}}, 'get_flows', True, True),
        ({'admin': {'role': 'readOnly'}}, 'update_descriptions', False, False),
        ({'admin': {'role': 'READONLY'}}, 'docs_query', True, True),
        ({'admin': {'role': 'ReadOnly'}}, 'create_flow', False, False),
    ...
    ids=[
        ...
        'readonly_role_read_allowed',
        'readonly_role_write_blocked',
        'readonly_uppercase_read_allowed',
        'readonly_titlecase_write_blocked',
        'admin_read_allowed',
        'admin_write_allowed',
