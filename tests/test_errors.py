...
class TestEnhancedToolErrorDecorator:
    ...
    def function_that_raises_http_500_with_exception_id(self, mock_http_response_500, mock_http_request):
        ...
        async def func():
            error_message = ("Server error '500 Internal Server Error' for url 'https://api.example.com/test' "
                             '(Exception ID: test-exc-500-123) - Database connection timeout')
    ...
    @pytest.mark.asyncio
    async def test_tool_errors_decorator_with_http_500_and_exception_id(
            self, function_that_raises_http_500_with_exception_id
    ):
    ...
    @pytest.mark.asyncio
    async def test_tool_errors_decorator_with_http_500_without_exception_id(
            self, function_that_raises_http_500_without_exception_id
    ):
    ...
    @pytest.mark.asyncio
    async def test_tool_errors_decorator_with_http_404_does_not_include_exception_id(
            self, function_that_raises_http_404
    ):
