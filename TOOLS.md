...
WHEN NOT TO USE:
- Do NOT use for orchestrations or flows (keboola.orchestrator, keboola.flow). Use the flows tools instead.
- Do NOT use for SQL transformations (keboola.snowflake-transformation, keboola.google-bigquery-transformation).
  Use the SQL transformation tools instead.
- Do NOT use for data applications (keboola.data-apps). Use the data applications tools instead.
...
WHEN NOT TO USE:
- Do NOT use for orchestrations or flows (keboola.orchestrator, keboola.flow). Use `create_flow` or
  `create_conditional_flow` from the flows tools instead.
- Do NOT use for SQL transformations (keboola.snowflake-transformation, keboola.google-bigquery-transformation).
...
WHEN NOT TO USE:
- Do NOT use for orchestrations or flows (keboola.orchestrator, keboola.flow). Use `update_flow` or
  `modify_flow` from the flows tools instead.
- Do NOT use for SQL transformations (keboola.snowflake-transformation, keboola.google-bigquery-transformation).
