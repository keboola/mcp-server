...
class SemanticGetDefinitionOutput(SemanticToolResponse):
    ...
    definition: SemanticObjectDefinition | None = Field(default=None, description='Canonical semantic object definition.')
...
class SemanticQueryPlan(BaseModel):
    ...
    resolved_dimensions: list[str] = Field(default_factory=list, description='Dimensions resolved in source/joined datasets.')
    unresolved_dimensions: list[str] = Field(default_factory=list, description='Dimensions not found in semantic model.')
...
class SemanticQueryPlanOutput(SemanticToolResponse):
    ...
    post_execution_checks: list[ConstraintCheck] = Field(default_factory=list, description='Post-execution validations.')
...
class SemanticDefineOutput(SemanticToolResponse):
    ...
    definition: SemanticObjectDefinition | None = Field(default=None, description='Resulting semantic object, if available.')
