...
#   timestamp: 2025-05-23T12:39:00+00:00
...
class Files(BaseModel):
    ...
    query: Optional[str] = Field(None, description='Query to filter files')
    ...
    processed_tags: Optional[List[str]] = Field(None, description='List of processed tags')
    changed_since: Optional[str] = Field(None, description='Filter by last change date')
...
class Files1(BaseModel):
    ...
    query: str = Field(..., description='Query to filter files')
    limit: Optional[int] = Field(None, description='Limit number of files')
    overwrite: Optional[bool] = Field(True, description='Whether to overwrite existing files')
    processed_tags: Optional[List[str]] = Field(None, description='List of processed tags')
    changed_since: Optional[str] = Field(None, description='Filter by last change date')
...
class Input(BaseModel):
    ...
    files: Optional[List[Union[Files, Files1, Files2, Files3]]] = None
...
class Table(BaseModel):
    ...
    delete_where_column: Optional[str] = Field(None, description='Column to filter deletions on')
    delete_where_values: Optional[List[str]] = Field(None, description='Values to filter deletions by')
    delete_where_operator: Optional[DeleteWhereOperator] = Field(
        DeleteWhereOperator.eq, description='Operator for deletion filtering'
    )
...
class File(BaseModel):
    ...
    is_public: Optional[bool] = Field(False, description='Whether the file is public')
    is_permanent: Optional[bool] = Field(False, description='Whether the file is permanent')
    is_encrypted: Optional[bool] = Field(True, description='Whether the file is encrypted')
    notify: Optional[bool] = Field(False, description='Whether to notify about the file')
